                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="tag_name" name="name" placeholder="Tag Name">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="tag_added_user">Added User</label>
                                <input type="text" class="form-control" id="tag_added_user" name="addedByUser" placeholder="User added tag">
                            </div>
                        </div>
