                    ...
                    <div class="input-group">
                        <select name="source_id" id="" class="form-control">
                            ...
                            @foreach($sources as $key => $source)
                                <option value="{{ $source->id }}" {!! ( isset($article->source) && $article->source->id == $source->id ) ? 'selected':'' !!}>{{ ($source->firstName ? $source->firstName.'_' : '') . ($source->middleName ? $source->middleName.'_' : '') . ($source->lastName ? $source->lastName : '')}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
