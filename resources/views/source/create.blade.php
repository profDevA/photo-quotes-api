                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="quote_title" name="quoteTitle" placeholder="Quote Title">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="meta_tag">Meta Tag</label>
                                <input type="text" class="form-control" id="meta_tag" name="metatag" placeholder="Source name">
                            </div>
                        </div>
